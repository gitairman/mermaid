...
sequenceDiagram
    ...
    deactivate server
    Note over browser, server: The server responds with HTTP status code 302, telling the browser<br/>to redirect to the address defined in the header's Location ../notes.
